            ...
            for($k=1;$k<=1;$k++)
            {
              echo '<tr>';
                        ...
                        {                   
                          ...
                          } elseif ($name[$i] == "click" || $name[$i] == "impression") {
                            echo ' <td style="display:none"><input  type="text"  name=' . $name[$i] . $k . ' id=' . $name[$i] . $k . '></td> ';
                          }
...
var row = table.insertRow(rowc);
    ...
    if (column[i]=="id"||column[i]=="date"||column[i]=="animation"||column[i]=="fcat"||column[i]=="client"||column[i]=="click"||column[i]=="impression"){
